    ...
    public class Robot extends Monster
   {
    //ARGS:  row, col, image collection
       public Robot(int r, int c, String[][][] image)
      {
         ...
         //super ARGS:  name, row, col, image collection, animation delay, stomp power, speed penalty, reload time, autoStompPower, projectileType, burnDamage
         ...
         setEnergyAbsorber(true);	//we don't eat enemy units but can absorb energy from electric towers, power plants and trains (and short circuit in water)
      	...
      	//ARGS:  name, row loc, col loc, image collection, speed penalty, reload time		
    ...
    //Gobzilly can grab electric towers and trains
